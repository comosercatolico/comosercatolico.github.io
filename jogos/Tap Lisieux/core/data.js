...
const nomesEstagio = Object.freeze([
    ...
    "Domínio do Caos",        "Ruínas Amaldiçoadas",      "Pântano da Perdição",
    "Caverna do Esquecimento","Templo da Heresia",         "Cume Sombrio",
    "Labirinto Infernal",     "Câmara do Julgamento",     "Fortaleza das Trevas",
    "Limiar do Inferno",      "Trono do Caos",
]);
...
const falasMonstros = Object.freeze({
    ...
    "Servo do Abismo":    ["O abismo te reclama!", "Mergulhe nas trevas!", "Não há saída!"],
    "Espectro Sombrio":   ["Você logo me pertencerá!", "A escuridão é tudo!", "A luz é uma ilusão!"],
});
