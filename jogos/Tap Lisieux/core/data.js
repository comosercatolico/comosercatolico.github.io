...
const tiposMonstros = Object.freeze([
    {
        nome: "Slime Corrompido",
        emojis: { normal:"💧", dor:"😖", medo:"😱", raiva:"👿", morte:"💀" },
        cor: "#4488ff",
        asset: "slime"
    },
    {
        nome: "Sapo-Gato das Sombras",
        emojis: { normal:"🐸", dor:"😵", medo:"😨", raiva:"💢", morte:"💀" },
        cor: "#8844ff",
        asset: "saga"
    },
    ...
    {
        nome: "Cavaleiro da Ira",
        emojis: { normal:"⚔️", dor:"🔥", medo:"😱", raiva:"👿", morte:"💀" },
        cor: "#e74c3c",
        asset: "ira"
    }
]);
...
const cenariosEstagio = Object.freeze([
    ...
    { min: 31, max: 40, asset: "cenario_inferno" }, // Ira/Avareza
    { min: 41, max: 999, asset: "cenario1" }
]);
...
const poolHerois = Object.freeze([
    ...
    { nome:"São Miguel",         raridade:"Lendário", emoji:"⚔️", arma:"Lança Divina",     bonus: "Ataque +150%"},
    { nome:"Santa Luzia",        raridade:"Raro",     emoji:"👁️", arma:"Vela da Graça",    bonus: "Crítico +15%"},
    { nome:"Santo Antônio",      raridade:"Raro",     emoji:"📖", arma:"Livro Sagrado",    bonus: "Exp +30%"  },
    { nome:"São Bento",          raridade:"Épico",    emoji:"✝️", arma:"Cruz de São Bento",bonus: "DPS +60%"  },
    { nome:"Santa Catarina",     raridade:"Raro",     emoji:"⚙️", arma:"Roda da Sabedoria",bonus: "Custo -25%"},
    { nome:"São Sebastião",      raridade:"Comum",    emoji:"🏹", arma:"Arco Abençoado",   bonus: "Ataque +15%"},
    { nome:"São Jorge",          raridade:"Épico",    emoji:"🐉", arma:"Lança de São Jorge",bonus:"Chefe +80%"},
    { nome:"Nossa Senhora",      raridade:"Lendário", emoji:"🌹", arma:"Rosário Sagrado",  bonus: "Todos +100%"},
]);
