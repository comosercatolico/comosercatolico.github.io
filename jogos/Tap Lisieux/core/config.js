...
const CONFIG = Object.freeze({
    ...
    // ════════════════════════════════════════
    MOEDA_INICIAL:          0,
    MOEDA_BASE_KILL:        25,     // moeda base por kill no estágio 1 (BUFFED)
    MOEDA_ESCALA:           1.18,   // fator de escala por estágio (BUFFED)
    MOEDA_CHEFE_MULT:       15,     // chefe vale 15x a moeda normal (BUFFED)
