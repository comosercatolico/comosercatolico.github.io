export const listaSantos = [
  ...
  { nome: "Santo Ambrósio", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São João Crisóstomo", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São Basílio Magno", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São Gregório Nazianzeno", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "Santo Atanásio", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São Leão Magno", categorias: ["Doutor da Igreja", "Papa"], pasta: "doutores" },
  { nome: "São Hilário de Poitiers", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São Cirilo de Alexandria", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São Cirilo de Jerusalém", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São João Damasceno", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores/sao-joao-damasceno" },
  { nome: "São Pedro Crisólogo", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "Santo Isidoro de Sevilha", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São Beda o Venerável", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores/sao-beda-o-veneravel" },
  { nome: "São Pedro Damião", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "Santo Anselmo de Cantuária", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São Bernardo de Claraval", categorias: ["Doutor da Igreja", "Abade"], pasta: "doutores" },
  { nome: "São Boaventura", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "Santo Alberto Magno", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "Santo Antônio de Pádua", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores/santo-antonio-de-padua" },
  { nome: "São João da Cruz", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores/sao-joao-da-cruz" },
  { nome: "São Pedro Canísio", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores/sao-pedro-canisio" },
  { nome: "São Roberto Belarmino", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São Francisco de Sales", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "Santo Afonso de Ligório", categorias: ["Doutor da Igreja", "Bispo"], pasta: "doutores" },
  { nome: "São Lourenço de Brindisi", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores/sao-lourenco-de-brindisi" },
  { nome: "Santa Teresa d'Ávila", categorias: ["Doutor da Igreja", "Virgem"], pasta: "doutores" },
  { nome: "Santa Catarina de Sena", categorias: ["Doutor da Igreja", "Virgem"], pasta: "doutores" },
  { nome: "Santa Teresinha do Menino Jesus", categorias: ["Doutor da Igreja", "Virgem"], pasta: "doutores" },
  { nome: "Santa Hildegarda de Bingen", categorias: ["Doutor da Igreja", "Virgem"], pasta: "doutores" },
  { nome: "São João de Ávila", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores/sao-joao-de-avila" },
  { nome: "São Gregório de Narek", categorias: ["Doutor da Igreja", "Monge"], pasta: "doutores" },
  { nome: "Santo Efrém da Síria", categorias: ["Doutor da Igreja", "Diácono"], pasta: "doutores" },
  { nome: "São Ireneu de Lyon", categorias: ["Doutor da Igreja", "Bispo", "Mártir"], pasta: "doutores" },
  ...
  { nome: "São Valentim", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-valentim" },
  ...
  { nome: "São Fidelis de Sigmaringa", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-fidelis-de-sigmaringa" },
  { nome: "São Maximiliano Kolbe", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-maximiliano-kolbe" },
  ...
  { nome: "São André Kim", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-andre-kim" },
  ...
  { nome: "São Roberto Southwell", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-roberto-southwell" },
  { nome: "São Edmundo Campion", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-edmundo-campion" },
  { nome: "São Pedro de Arbués", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-pedro-de-arbues" },
  ...
  { nome: "São Teófano Vénard", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-teofano-venard" },
  { nome: "São Paulo Chong", categorias: ["Mártir"] },
  { nome: "São João de Triora", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-joao-de-triora" },
  { nome: "São Francisco de Capillas", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-francisco-de-capillas" },
  ...
  { nome: "São Rafael de Mitilene", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-rafael-de-mitilene" },
  { nome: "São Nicolau de Mitilene", categorias: ["Mártir", "Monge"] },
  { nome: "Santa Irene de Mitilene", categorias: ["Mártir"] },
  { nome: "São Cosme Etolo", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-cosme-etolo" },
  ...
  { nome: "São Pedro de Verona", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros/sao-pedro-de-verona" },
  ...
  { nome: "São Francisco Xavier", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros/sao-francisco-xavier" },
  { nome: "São José de Anchieta", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros/sao-jose-de-anchieta" },
  ...
  { nome: "São Junípero Serra", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros/sao-junipero-serra" },
  { nome: "São Damião de Molokai", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros/sao-damiao-de-molokai" },
  { nome: "São Roque González", categorias: ["Missionário", "Mártir"] },
  { nome: "São Pedro Claver", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros/sao-pedro-claver" },
  { nome: "São Turíbio de Mongrovejo", categorias: ["Missionário", "Bispo"] },
  { nome: "São Daniel Comboni", categorias: ["Missionário", "Bispo"] },
  { nome: "São Luís Beltrão", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros/sao-luis-beltrao" },
  { nome: "São Francisco Solano", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros/sao-francisco-solano" },
  ...
  { nome: "São Leopoldo Mandic", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros/sao-leopoldo-mandic" },
  ...
  { nome: "São Domingos de Gusmão", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-domingos-de-gusmao" },
  { nome: "Santo Inácio de Loyola", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/santo-inacio-de-loyola" },
  { nome: "São Bruno de Colônia", categorias: ["Fundador", "Monge"] },
  { nome: "São Norberto", categorias: ["Fundador", "Bispo"] },
  { nome: "São Camilo de Lellis", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-camilo-de-lellis" },
  { nome: "São João de Deus", categorias: ["Fundador", "Religioso"] },
  { nome: "São Vicente de Paulo", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-vicente-de-paulo" },
  { nome: "São João Bosco", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-joao-bosco" },
  { nome: "São Filipe Neri", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-filipe-neri" },
  { nome: "São Caetano", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-caetano" },
  { nome: "São Jerônimo Emiliani", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-jeronimo-emiliani" },
  { nome: "São José de Calasanz", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-jose-de-calasanz" },
  { nome: "São Paulo da Cruz", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-paulo-da-cruz" },
  { nome: "São Pedro Julião Eymard", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-pedro-juliano-eymard" },
  { nome: "São João Eudes", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-joao-eudes" },
  { nome: "São Luís Maria de Montfort", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-luis-maria-de-montfort" },
  { nome: "São Francisco de Paula", categorias: ["Fundador", "Eremita"] },
  { nome: "São Luís Orione", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-luis-orione" },
  { nome: "São João Calabria", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-joao-calabria" },
  { nome: "São Vicente Pallotti", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-vicente-pallotti" },
  { nome: "São Gaspar del Búfalo", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-gaspar-del-bufalo" },
  { nome: "São Tiago Alberione", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-tiago-alberione" },
  { nome: "São Francisco Coll", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-francisco-coll" },
  { nome: "São Enrique de Ossó", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros/sao-enrique-de-osso" },
  ...
  { nome: "São Pio de Pietrelcina", categorias: ["Presbítero", "Místico"], pasta: "presbiteros/sao-pio-de-pietrelcina" },
  ...
  { nome: "São Leonardo de Porto Maurício", categorias: ["Presbítero"], pasta: "presbiteros/sao-leonardo-de-porto-mauricio" },
  { nome: "São Pascoal Bailão", categorias: ["Religioso"] },
  { nome: "São Bernardino de Sena", categorias: ["Presbítero"], pasta: "presbiteros/sao-bernardino-de-sena" },
  { nome: "São Diogo de Alcalá", categorias: ["Religioso"] },
  { nome: "São Pedro de Alcântara", categorias: ["Presbítero"], pasta: "presbiteros/sao-pedro-de-alcantara" },
  { nome: "São Cláudio de la Colombière", categorias: ["Presbítero"], pasta: "presbiteros/sao-claudio-de-la-colombiere" },
  { nome: "Santa Margarida Maria Alacoque", categorias: ["Virgem"] },
  { nome: "São Francisco de Borja", categorias: ["Presbítero"], pasta: "presbiteros/sao-francisco-de-borja" },
  { nome: "São Estanislau Kostka", categorias: ["Religioso"] },
  { nome: "São João Berchmans", categorias: ["Religioso"] },
  { nome: "São João de Sahagún", categorias: ["Presbítero"], pasta: "presbiteros/sao-joao-de-sahagun" },
  { nome: "São Tomás de Vilanova", categorias: ["Bispo"] },
  { nome: "São Nicolau Tolentino", categorias: ["Presbítero"], pasta: "presbiteros/sao-nicolau-tolentino" },
  { nome: "São João de Kanty", categorias: ["Presbítero"], pasta: "presbiteros/sao-joao-de-kanty" },
  { nome: "São Jacinto", categorias: ["Presbítero"], pasta: "presbiteros/sao-jacinto" },
  { nome: "São Vicente Ferrer", categorias: ["Presbítero"], pasta: "presbiteros/sao-vicente-ferrer" },
  { nome: "São Raimundo de Penaforte", categorias: ["Presbítero"], pasta: "presbiteros/sao-raimundo-de-penaforte" },
  ...
  { nome: "São Clemente Hofbauer", categorias: ["Presbítero"], pasta: "presbiteros/sao-clemente-hofbauer" },
  { nome: "São João Neumann", categorias: ["Bispo"] },
  { nome: "São Pedro Fourier", categorias: ["Presbítero"], pasta: "presbiteros/sao-pedro-fourier" },
