...
{ nome: "São Rafael Arcanjo", categorias: ["Arcanjo"], pasta: "arcanjos" }, 
  ...
  { nome: "São Jerônimo", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores" },
  ...
  { nome: "São João Damasceno", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores" },
  ...
  { nome: "São Beda o Venerável", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores" },
  ...
  { nome: "Santo Antônio de Pádua", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores" },
  { nome: "São João da Cruz", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores" },
  { nome: "São Pedro Canísio", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores" },
  ...
  { nome: "São Lourenço de Brindisi", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores" },
  ...
  { nome: "São João de Ávila", categorias: ["Doutor da Igreja", "Presbítero"], pasta: "doutores" },
  ...
  { nome: "São Valentim", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Fidelis de Sigmaringa", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Maximiliano Kolbe", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São André Kim", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Roberto Southwell", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Edmundo Campion", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Pedro de Arbués", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Teófano Vénard", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Paulo Chong", categorias: ["Mártir"] },
  { nome: "São João de Triora", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Francisco de Capillas", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Rafael de Mitilene", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Nicolau de Mitilene", categorias: ["Mártir", "Monge"] },
  { nome: "Santa Irene de Mitilene", categorias: ["Mártir"] },
  { nome: "São Cosme Etolo", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Pedro de Verona", categorias: ["Mártir", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Francisco Xavier", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros" },
  { nome: "São José de Anchieta", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Junípero Serra", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Damião de Molokai", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Roque González", categorias: ["Missionário", "Mártir"] },
  { nome: "São Pedro Claver", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Turíbio de Mongrovejo", categorias: ["Missionário", "Bispo"] },
  { nome: "São Daniel Comboni", categorias: ["Missionário", "Bispo"] },
  { nome: "São Luís Beltrão", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Francisco Solano", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Leopoldo Mandic", categorias: ["Missionário", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São João de Kronstadt", categorias: ["Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Domingos de Gusmão", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "Santo Inácio de Loyola", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Bruno de Colônia", categorias: ["Fundador", "Monge"] },
  { nome: "São Norberto", categorias: ["Fundador", "Bispo"] },
  { nome: "São Camilo de Lellis", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São João de Deus", categorias: ["Fundador", "Religioso"] },
  { nome: "São Vicente de Paulo", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São João Bosco", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Filipe Neri", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Caetano", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Jerônimo Emiliani", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São José de Calasanz", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Paulo da Cruz", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Pedro Julião Eymard", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São João Eudes", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Luís Maria de Montfort", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Francisco de Paula", categorias: ["Fundador", "Eremita"] },
  { nome: "São Luís Orione", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São João Calabria", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Vicente Pallotti", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Gaspar del Búfalo", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Tiago Alberione", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Francisco Coll", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  { nome: "São Enrique de Ossó", categorias: ["Fundador", "Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Pio de Pietrelcina", categorias: ["Presbítero", "Místico"], pasta: "presbiteros" },
  ...
  { nome: "São Leonardo de Porto Maurício", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São Pascoal Bailão", categorias: ["Religioso"] },
  { nome: "São Bernardino de Sena", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São Diogo de Alcalá", categorias: ["Religioso"] },
  { nome: "São Pedro de Alcântara", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São Cláudio de la Colombière", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "Santa Margarida Maria Alacoque", categorias: ["Virgem"] },
  { nome: "São Francisco de Borja", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São Estanislau Kostka", categorias: ["Religioso"] },
  { nome: "São João Berchmans", categorias: ["Religioso"] },
  { nome: "São João de Sahagún", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São Tomás de Vilanova", categorias: ["Bispo"] },
  { nome: "São Nicolau Tolentino", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São João de Kanty", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São Jacinto", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São Vicente Ferrer", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São Raimundo de Penaforte", categorias: ["Presbítero"], pasta: "presbiteros" },
  ...
  { nome: "São Clemente Hofbauer", categorias: ["Presbítero"], pasta: "presbiteros" },
  { nome: "São João Neumann", categorias: ["Bispo"] },
  { nome: "São Pedro Fourier", categorias: ["Presbítero"], pasta: "presbiteros" },
